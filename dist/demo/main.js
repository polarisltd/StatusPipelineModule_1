...
var DataSource = /** @class */ (function () {
    function DataSource() {
        ...
        this.boardSubject$ = new rxjs__WEBPACK_IMPORTED_MODULE_0__["BehaviorSubject"](this.dataSource);
...
module.exports = "p, div, textarea, h2 {\n  font-family: Lato;\n}\n\n.dvtx-node {\n  padding: 3px 5px;\n  font-size: 0.9rem;\n}\n\n.dvtx-node span {\n  /**v ertical-align: -webkit-baseline-middle; */\n}\n\n.dvtx-node.selected {\n  font-size: 0.9rem;\n  padding: 3px 5px;\n  color: white;\n  background-color: #0090cf;\n  border-radius: 3px;\n}\n\n::ng-deep .dvtx-node span .mat-icon {\n  font-size: 14px;\n  height: 14px;\n  width: 16px;\n  line-height: 14px;\n  vertical-align: middle; \n  padding-bottom: 3px;\n}\n\n.dvtx-node-checkbox {\n  display: inline-block;\n  margin-right: 3px;\n}\n\n.message-area{\n  height: 50px;\n  color: blue;\n  white-space:pre-wrap;\n  background-color: dodgerblue;\n  overflow-y: scroll;\n  /*resize: none; *//* Remove this if you want the user to resize the textarea */\n}\n\n/*# sourceMappingURL=data:application/json;base64, */"
...
/* harmony import */ var _DataSource__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./DataSource */ "./src/app/DataSource.ts");
...
var AppComponent = /** @class */ (function () {
    function AppComponent(dataSource) {
        ...
        this.onTransition = new _angular_core__WEBPACK_IMPORTED_MODULE_0__["EventEmitter"]();
        this.onClickColumnTitle = new _angular_core__WEBPACK_IMPORTED_MODULE_0__["EventEmitter"]();
        this.onCardClick = new _angular_core__WEBPACK_IMPORTED_MODULE_0__["EventEmitter"]();
        this.onAddCard = new _angular_core__WEBPACK_IMPORTED_MODULE_0__["EventEmitter"]();
        this.onDeleteCard = new _angular_core__WEBPACK_IMPORTED_MODULE_0__["EventEmitter"]();
        this.onUpdateCard = new _angular_core__WEBPACK_IMPORTED_MODULE_0__["EventEmitter"]();
        this.onRemoveColumn = new _angular_core__WEBPACK_IMPORTED_MODULE_0__["EventEmitter"]();
        this.messageArea = 'Demo events.';
        this.dataSource = dataSource;
        this.onTransition.subscribe(function (item) { return _this.showMessage('Drag-n-drop:', item); });
        this.onClickColumnTitle.subscribe(function (item) { return _this.showMessage('click column:', item); });
        this.onAddCard.subscribe(function (item) { return _this.showMessage('addCard:', item); });
        this.onUpdateCard.subscribe(function (item) { return _this.showMessage('updateCard', item); });
        this.onDeleteCard.subscribe(function (item) { return _this.showMessage('deleteCard', item); });
        this.onRemoveColumn.subscribe(function (item) { return _this.showMessage('deleteColumn', item); });
        this.onCardClick.subscribe(function (item) { return _this.showMessage('cardClick', item); });
    }
    ...
    AppComponent.prototype.validateDropRules = function (statusChange) {
        console.log('app.component#validateDragRules  ', statusChange);
        return (this.ALLOWED_TRANSITIONS.filter(function (elem) { return elem[0] === statusChange.src.id &&
            elem[1] === statusChange.dst.id; }).length > 0);
    };
    AppComponent.prototype.showMessage = function (prefix, value) {
        var _this = this;
        this.messageArea = prefix + JSON.stringify(value);
        console.log('=>', this.messageArea);
        setTimeout(function () {
            _this.messageArea = 'Demo events.';
        }, 10000);
    };
    AppComponent = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Component"])({
            ...
            providers: [_DataSource__WEBPACK_IMPORTED_MODULE_1__["DataSource"]],
...
var BoardComponentComponent = /** @class */ (function () {
    ...
    ], BoardComponentComponent.prototype, "boardSubject$", void 0);
    __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Input"])(),
        __metadata("design:type", _angular_core__WEBPACK_IMPORTED_MODULE_0__["EventEmitter"])
    ], BoardComponentComponent.prototype, "onTransition", void 0);
    __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Input"])(),
        __metadata("design:type", _angular_core__WEBPACK_IMPORTED_MODULE_0__["EventEmitter"])
    ], BoardComponentComponent.prototype, "onClickColumnTitle", void 0);
    __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Input"])(),
        __metadata("design:type", _angular_core__WEBPACK_IMPORTED_MODULE_0__["EventEmitter"])
    ], BoardComponentComponent.prototype, "onAddCard", void 0);
    __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Input"])(),
        __metadata("design:type", _angular_core__WEBPACK_IMPORTED_MODULE_0__["EventEmitter"])
    ], BoardComponentComponent.prototype, "onDeleteCard", void 0);
    __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Input"])(),
        __metadata("design:type", _angular_core__WEBPACK_IMPORTED_MODULE_0__["EventEmitter"])
    ], BoardComponentComponent.prototype, "onUpdateCard", void 0);
    __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Input"])(),
        __metadata("design:type", _angular_core__WEBPACK_IMPORTED_MODULE_0__["EventEmitter"])
    ], BoardComponentComponent.prototype, "onCardClick", void 0);
    __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Input"])(),
        __metadata("design:type", _angular_core__WEBPACK_IMPORTED_MODULE_0__["EventEmitter"])
    ], BoardComponentComponent.prototype, "onRemoveColumn", void 0);
    __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Input"])(),
    ...
    ], BoardComponentComponent.prototype, "validateDropRules", void 0);
...
var CardComponentComponent = /** @class */ (function () {
    function CardComponentComponent(fb) {
        this.fb = fb;
        this.isCardEditMode = false;
        this.cardFormChanged = false;
    }
    CardComponentComponent.prototype.ngOnInit = function () {
        ...
        this.cardForm.valueChanges.subscribe(function (form) {
            console.log('CardComponent#cardForm.valueChanges');
            _this.cardFormChanged = true;
            _this.card.title = form.title;
            _this.card.content = form.content;
        });
    };
    CardComponentComponent.prototype.clickOnCardField = function (event) {
        console.log('CardComponent#-> onCardTitleClick ', this.card.title);
    };
    CardComponentComponent.prototype.handleDragStart = function (event, card) {
    ...
    CardComponentComponent.prototype.extractDragSourceId = function (event) {
        // extract drag source as we coded it.
        return event.dataTransfer.types.find(function (entry) { return entry.includes("id="); }).substr(3);
    };
    CardComponentComponent.prototype.insertDragSourceId = function (event, id) {
    ...
    ], CardComponentComponent.prototype, "emptyItem", void 0);
    __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Input"])(),
        __metadata("design:type", rxjs__WEBPACK_IMPORTED_MODULE_3__["Subject"])
    ], CardComponentComponent.prototype, "boardSubject$", void 0);
    __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Input"])(),
        __metadata("design:type", _shared_card__WEBPACK_IMPORTED_MODULE_2__["Card"])
    ], CardComponentComponent.prototype, "card", void 0);
    __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Input"])(),
        __metadata("design:type", _angular_core__WEBPACK_IMPORTED_MODULE_0__["EventEmitter"])
    ], CardComponentComponent.prototype, "onUpdateCard", void 0);
    __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Input"])(),
        __metadata("design:type", _angular_core__WEBPACK_IMPORTED_MODULE_0__["EventEmitter"])
    ], CardComponentComponent.prototype, "onDeleteCard", void 0);
    __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Input"])(),
        __metadata("design:type", _angular_core__WEBPACK_IMPORTED_MODULE_0__["EventEmitter"])
    ], CardComponentComponent.prototype, "onCardClick", void 0);
...
var ColumnComponentComponent = /** @class */ (function () {
    function ColumnComponentComponent() {
        var _this = this;
        this.dragClass = 'drag-color0'; // drag/drop enable/disable color
        this.inTimer = false;
        this.colorDragProtectedArea = function (node) {
            _this.dragClass = 'drag-color1';
            if (!_this.inTimer) {
                _this.inTimer = true;
                setTimeout(function () {
                    console.log('-> reset ngClass', ' =', node.id);
                    _this.dragClass = 'drag-color0';
                    _this.inTimer = false;
                }, 2000);
            }
        };
    }
    ColumnComponentComponent.prototype.ngOnInit = function () {
        var _this = this;
        this.board$ = this.boardSubject$;
        this.board$.subscribe(function (board) {
    ...
    ColumnComponentComponent.prototype.getCards = function (columnId, board) {
        return board.cards.filter(function (card) { return columnId === card.columnId; });
    };
    ColumnComponentComponent.prototype.onColumnClick = function (event) {
        console.log('ColumnComponent#-> onColumnClick ', this.column.title);
        this.onClickColumnTitle.emit(this.column);
    };
    ColumnComponentComponent.prototype.handleDragStart = function (event, node) {
    };
    ColumnComponentComponent.prototype.handleDragOver = function (event, node) {
        event.preventDefault();
        //
    ...
    ColumnComponentComponent.prototype.validateDropRulesWrapper = function (srcCardId, targetColumnId) {
        ...
        var srcColumn = this.board.columns.find(function (entry) { return entry.id === srcCard.columnId; });
        var targColumn = this.board.columns.find(function (entry) { return entry.id === targetColumnId; });
    ...
    ColumnComponentComponent.prototype.onColumnButtonClick = function (column) {
        console.log('ColumnComponent#onColumnButtonClick_AddCard ', column.id);
        var c = this.database.addCardRefColumn(column.id);
        this.onAddCard.emit(c);
    };
    ColumnComponentComponent.prototype.onColumnButtonClickRemove = function (column) {
        console.log('ColumnComponent#onColumnButtonClick', column.id);
        var removedColumn = this.database.removeColumn(column.id);
        this.onRemoveColumn.emit(removedColumn);
    };
    ColumnComponentComponent.prototype.extractDragSourceId = function (event) {
        return event.dataTransfer.types.find(function (entry) { return entry.includes("id="); }).substr(3);
    };
    __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Input"])(),
        __metadata("design:type", rxjs__WEBPACK_IMPORTED_MODULE_1__["Subject"])
    ], ColumnComponentComponent.prototype, "boardSubject$", void 0);
    __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Input"])(),
        __metadata("design:type", _shared_column__WEBPACK_IMPORTED_MODULE_3__["Column"])
    ], ColumnComponentComponent.prototype, "column", void 0);
    __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Input"])(),
        __metadata("design:type", _angular_core__WEBPACK_IMPORTED_MODULE_0__["EventEmitter"])
    ], ColumnComponentComponent.prototype, "onTransition", void 0);
    __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Input"])(),
        __metadata("design:type", _angular_core__WEBPACK_IMPORTED_MODULE_0__["EventEmitter"])
    ], ColumnComponentComponent.prototype, "onClickColumnTitle", void 0);
    __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Input"])(),
        __metadata("design:type", Function)
    ], ColumnComponentComponent.prototype, "validateDropRules", void 0);
    __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Input"])(),
        __metadata("design:type", _angular_core__WEBPACK_IMPORTED_MODULE_0__["EventEmitter"])
    ], ColumnComponentComponent.prototype, "onAddCard", void 0);
    __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Input"])(),
        __metadata("design:type", _angular_core__WEBPACK_IMPORTED_MODULE_0__["EventEmitter"])
    ], ColumnComponentComponent.prototype, "onRemoveColumn", void 0);
    __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Input"])(),
        __metadata("design:type", _angular_core__WEBPACK_IMPORTED_MODULE_0__["EventEmitter"])
    ], ColumnComponentComponent.prototype, "onCardClick", void 0);
    __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Input"])(),
        __metadata("design:type", _angular_core__WEBPACK_IMPORTED_MODULE_0__["EventEmitter"])
    ], ColumnComponentComponent.prototype, "onUpdateCard", void 0);
    __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Input"])(),
        __metadata("design:type", _angular_core__WEBPACK_IMPORTED_MODULE_0__["EventEmitter"])
    ], ColumnComponentComponent.prototype, "onDeleteCard", void 0);
    ...
    return ColumnComponentComponent;
}());
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "ColumnsSortPipe", function() { return ColumnsSortPipe; });
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm5/core.js");
var __decorate = (undefined && undefined.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
...
var ColumnsSortPipe = /** @class */ (function () {
    ...
    ColumnsSortPipe = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Pipe"])({ name: "sort" })
    ], ColumnsSortPipe);
    return ColumnsSortPipe;
}());
...
var Database = /** @class */ (function () {
    ...
    Database.prototype.setupObservable = function () {
        // Important!
        // remebemr that observable will return data later then expected :)
        // this.boardSubject$.next(this.board);
    };
    Database.prototype.getBoardObservable = function () {
        return this.board$;
    };
    Database.prototype.removeCard = function (cardId) {
        var c = this.boardInternal.cards.find(function (c) { return c.id === cardId; });
        this.boardInternal.cards.splice(this.boardInternal.cards.indexOf(c), 1);
        this.boardSubject$.next(this.boardInternal);
    };
    Database.prototype.addCardRefCard = function (cardId) {
        var card = this.boardInternal.cards.find(function (c) { return c.id === cardId; });
        var newCard = new _card__WEBPACK_IMPORTED_MODULE_0__["Card"]();
    ...
    Database.prototype.addCardRefColumn = function (columnId) {
        var c = this.boardInternal.columns.find(function (c) { return c.id === columnId; });
        var newCard = new _card__WEBPACK_IMPORTED_MODULE_0__["Card"]();
        newCard.id = this.uuidv4();
    ...
    Database.prototype.getColumn = function (columnId) {
        var column = this.boardInternal.columns.find(function (c) { return c.id === columnId; });
        return column;
    };
    Database.prototype.getCard = function (columnId) {
        var card = this.boardInternal.cards.find(function (c) { return c.id === columnId; });
        return card;
    };
    /** drag n drop support. Move card to different column */
    Database.prototype.moveCard = function (cardId, targetColumnId) {
        console.log('moveCard boardInternal', this.boardInternal);
        var card = this.boardInternal.cards.find(function (c) { return c.id === cardId; });
        var idxC = this.boardInternal.cards.indexOf(card);
    ...
    Database.prototype.removeColumn = function (columnId) {
        var column = this.boardInternal.columns.find(function (c) { return c.id === columnId; });
        // make sure to remove only empty
        var cardsInThisColumn = this.boardInternal.cards.filter(function (c) { return c.columnId === columnId; });
        if (!cardsInThisColumn || cardsInThisColumn.length === 0)
            this.boardInternal.columns.splice(this.boardInternal.columns.indexOf(column), 1);
        this.boardSubject$.next(this.boardInternal);
        return column;
    };
    Database.prototype.uuidv4 = function () {
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "StatusPipelineShared", function() { return StatusPipelineShared; });
var StatusPipelineShared = /** @class */ (function () {
    function StatusPipelineShared() {
    }
    return StatusPipelineShared;
}());
...
var TaskPipelineModule = /** @class */ (function () {
    function TaskPipelineModule() {
    }
    TaskPipelineModule = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["NgModule"])({
            declarations: [
...
module.exports = __webpack_require__(/*! /Users/robertspolis/projects/angular_projects/StatusPipelineModule_20180211/StatusPipelineModule_1/src/main.ts */"./src/main.ts");
